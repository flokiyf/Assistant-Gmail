...
export default function ChatBot({ emails }: ChatBotProps) {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Salut ! 👋 Je suis votre assistant Gmail IA. Posez-moi des questions sur vos emails !',
      timestamp: new Date()
    }
  ])
  ...
  const getSuggestedQuestions = () => [
    ...
    "Résume-moi les emails d'aujourd'hui",
    "Y a-t-il des emails urgents ?",
    "Qui m'a envoyé le plus d'emails ?",
    "Quels sont les derniers emails reçus ?"
  ]
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-white rounded-lg shadow-2xl border border-gray-200 flex flex-col z-40">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-t-lg">
            <h3 className="font-bold text-lg">🤖 Assistant Gmail IA</h3>
